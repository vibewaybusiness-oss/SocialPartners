...
export const BACKEND_CONFIG = {
  ...
  url: process.env.BACKEND_URL || "http://localhost:8200",

  // Fallback URLs for different environments
  fallbackUrls: {
    localhost: 'http://localhost:8200',
    wsl: `http://${WSL_IP}:8200`,
    windows: `http://${WINDOWS_HOST_IP}:8200`,
  },
...
export const FRONTEND_CONFIG = {
  url: process.env.FRONTEND_URL || `http://${WSL_IP}:3200`,
  port: 3200,
};
